...
export type PageManyWhereInput = {
  ...
  /** All values that are contained in given list. */
  seoTitle_in?: InputMaybe<Array<Scalars['String']>>;
  /** All values that are not equal to given value. */
  ...
  /** All values that are not contained in given list. */
  seoTitle_not_in?: InputMaybe<Array<Scalars['String']>>;
  /** All values not starting with the given string. */
...
export type PageQuery = { __typename?: 'Query', page?: { __typename?: 'Page', title?: string | null, subtitle?: string | null, seoTitle?: string | null } | null };
